...
with DAG(
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "728095081397-compute@developer.gserviceaccount.com",
                "network_uri": "projects/burnished-road-443006-q4/global/networks/default",
                "subnetwork_uri": "projects/burnished-road-443006-q4/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="burnished-road-443006-q4",
        region="us-central1",
